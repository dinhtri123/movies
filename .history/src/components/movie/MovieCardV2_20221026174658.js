...
//   if (valueStar >= 8) {
//     star.style.background = "#7dce13";
//   }
//   if (valueStar >= 5.5) {
//     star.style.background = "#E6B325";
//   }
//   if (valueStar < 5.5) {
//     star.style.background = "#EB4747";
//   }
  return (
    <MovieCardV2Styles cate={cate} className={className}>
      <div className="image">
        <span className={`star ${(valueStar === 8) ? 'bg-[#7dce13] ' : 'bg-[#E6B325]'}`}>{vote_average}</span>
