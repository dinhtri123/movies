  ...
  return (
    <>
      ...
      <div className="card-item">
        ...
        <div className="item">
          <span className="item-title"><LoadingSkeleton width="100%" height = '15px'></LoadingSkeleton></span>
          <span className="item-since">
          <LoadingSkeleton width="50%" height = '5px'></LoadingSkeleton>
          </span>
      </div>
      <div className="star">
          <span className="number"><LoadingSkeleton width="100%" height = '15px'></LoadingSkeleton></span>
        </div>
    </div>
    </>
  );
