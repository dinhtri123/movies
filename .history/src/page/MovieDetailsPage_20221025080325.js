      ...
      <div className="container main">
        ...
        <div className="right">
          ...
          <div className="content">
            <div className="card">
                  <img src="https://images.unsplash.com/photo-1666551158841-29b196bde938?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=453&q=80" alt="" />
                  <div className="content-right">
                    <p className="cast_title">Jame</p>
                  </div>
            </div>
          </div>
        </div>
