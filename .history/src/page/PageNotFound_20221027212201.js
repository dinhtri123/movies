  ...
  return (
    <PageNotFoundStyles>
      <div className="page-content">
        <img src="/public/error.png" alt="notfound"  />
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="image">
