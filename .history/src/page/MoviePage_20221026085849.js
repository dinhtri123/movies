...
const MoviePage = () => {
  ...
  const [url, setUrl] = useState(`https://api.themoviedb.org/3/movie/popular?api_key=bee9d365514775f0a6d69d0ecb510c45&page=${nextPage}`);
  ...
  useEffect(() => {
    if (filterDebounce) {
      ...
      setUrl(`https://api.themoviedb.org/3/movie/popular?api_key=bee9d365514775f0a6d69d0ecb510c45&page=${nextPage}`)
    }
